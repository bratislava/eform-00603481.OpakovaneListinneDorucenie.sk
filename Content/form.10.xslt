...
<div id="layoutCell7694" class="cell " >		
		...
		<label class="fieldLabel" title="" for="IdentifierTypeCodelistCode" style="display: none">IdentifierTypeCodelistCode </label><span class="fieldContent" style="display: none"><input id="IdentifierTypeCodelistCode" name="IdentifierTypeCodelistCode" title="" type="text" class="xsd_string textBox "  maxlength="100" size="190"  alt="" value="CL004001" ><xsl:if test="boolean(./*[name() = 'IdentifierTypeCodelistCode']/@isReadOnly = 'true')"><xsl:attribute name="readonly">readonly</xsl:attribute><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:if test="./*[name() = 'IdentifierTypeCodelistCode']"><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'IdentifierTypeCodelistCode']"/></xsl:attribute></xsl:if></input>
</span>	
		<div class="clear"> </div>
</div>							
...
<div id="layoutCell7696" class="cell " >		
		...
		<label class="fieldLabel" title="" for="IdentifierTypeItemName" style="display: none">IdentifierTypeItemName </label><span class="fieldContent" style="display: none"><input id="IdentifierTypeItemName" name="IdentifierTypeItemName" title="" type="text" class="xsd_string textBox "  maxlength="128" size="190"  alt="" value="IČO (Identifikačné číslo organizácie)" ><xsl:if test="boolean(./*[name() = 'IdentifierTypeItemName']/@isReadOnly = 'true')"><xsl:attribute name="readonly">readonly</xsl:attribute><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:if test="./*[name() = 'IdentifierTypeItemName']"><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'IdentifierTypeItemName']"/></xsl:attribute></xsl:if></input>
</span>	
		<div class="clear"> </div>
</div>							
...
<div id="layoutCell7515" class="cell " >		
		...
		<label class="fieldLabel" title="" for="SenderMunicipalityCodeList" style="display: none">SenderMunicipalityCodeList </label><span class="fieldContent" style="display: none"><input id="SenderMunicipalityCodeList" name="SenderMunicipalityCodeList" title="" type="text" class="xsd_string textBox "  maxlength="100" size="190"  alt="" value="CL000025" ><xsl:if test="boolean(./*[name() = 'SenderMunicipalityCodeList']/@isReadOnly = 'true')"><xsl:attribute name="readonly">readonly</xsl:attribute><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:if test="./*[name() = 'SenderMunicipalityCodeList']"><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'SenderMunicipalityCodeList']"/></xsl:attribute></xsl:if></input>
</span>	
		<div class="clear"> </div>
</div>							
			...
			<div class="clear"> </div>
					...
					<div id="repetitionCommandslayoutRow5045" class="sectionPager">
						<xsl:if test="position() != last()"><xsl:attribute name="style"><xsl:text>display:none;</xsl:text></xsl:attribute></xsl:if>
								<span id="addSectionlayoutRow5045" class="button addRemoveSection" onclick="addSection(0, 1, this)" title="Pridať sekciu Poučenie">Pridať</span>
				<span id="removeSectionlayoutRow5045" class="button addRemoveSection" onclick="removeSection(0, this)" title="Odobrať sekciu Poučenie">Odobrať</span>	
			</div>
			</div>	
			</xsl:for-each>	
		...
		<div class="clear"> </div>
			...
			<div class="clear"> </div>
					...
					<div id="repetitionCommandslayoutRow5037" class="sectionPager">
						<xsl:if test="position() != last()"><xsl:attribute name="style"><xsl:text>display:none;</xsl:text></xsl:attribute></xsl:if>
								<span id="addSectionlayoutRow5037" class="button addRemoveSection" onclick="addSection(0, 1, this)" title="Pridať sekciu Príloha">Pridať</span>
				<span id="removeSectionlayoutRow5037" class="button addRemoveSection" onclick="removeSection(0, this)" title="Odobrať sekciu Príloha">Odobrať</span>	
			</div>
			</div>	
			</xsl:for-each>	
		...
		<div class="clear"> </div>
			...
			<div class="clear"> </div>
					...
					<div id="repetitionCommandslayoutRow5064" class="sectionPager">
						<xsl:if test="position() != last()"><xsl:attribute name="style"><xsl:text>display:none;</xsl:text></xsl:attribute></xsl:if>
								<span id="addSectionlayoutRow5064" class="button addRemoveSection" onclick="addSection(1, 99, this)" title="Pridať sekciu Osoby">Pridať</span>
				<span id="removeSectionlayoutRow5064" class="button addRemoveSection" onclick="removeSection(1, this)" title="Odobrať sekciu Osoby">Odobrať</span>	
			</div>
			</div>	
			</xsl:for-each>	
...
<div title="Info" class="LookupDetail"><div class="LookupDetailInfoText"></div><span class="lookupConfiguration" style="display: none;"><span class ="lookupComponentId">RecipientAfixPrefixItemName</span><span class ="fieldId">RecipientAfixPrefixItemCode</span><span class ="remoteSourceIdentifier"></span><span class ="remoteLookupCode">SUSR_0062</span><span class="fieldId">ServiceID</span></span></div>
...
<input class="LookupDetailInfo" type="hidden" />
<span class="lookupbutton ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">Vybrať</span>
<div title="Info" class="LookupDetail"><div class="LookupDetailInfoText"></div><span class="lookupConfiguration" style="display: none;"><span class ="lookupComponentId">RecipientAfixPostfixItemName</span><span class ="fieldId">RecipientAfixPostfixItemCode</span><span class ="remoteSourceIdentifier"></span><span class ="remoteLookupCode">SUSR_0063</span><span class="fieldId">ServiceID</span></span></div>
<div title="Vyberte hodnotu" class="LookupForm" style="display: none;">
...
<div id="layoutCell7549" class="cell " >		
		...
		<label class="fieldLabel" title="" for="RecipientAfixPostfixItemCode" style="display: none">Titul za ItemCode </label><span class="fieldContent" style="display: none"><input id="RecipientAfixPostfixItemCode" name="RecipientAfixPostfixItemCode" title="" type="text" class="xsd_string textBox "  maxlength="256" size="190"  alt="" value="" ><xsl:if test="boolean(./*[name() = 'RecipientAfixPostfixItemCode']/@isReadOnly = 'true')"><xsl:attribute name="readonly">readonly</xsl:attribute><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:if test="./*[name() = 'RecipientAfixPostfixItemCode']"><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'RecipientAfixPostfixItemCode']"/></xsl:attribute></xsl:if></input>
</span>	
		<div class="clear"> </div>
</div>							
...
<input class="LookupDetailInfo" type="hidden" />
<span class="lookupbutton ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">Vybrať</span>
<div title="Info" class="LookupDetail"><div class="LookupDetailInfoText"></div><span class="lookupConfiguration" style="display: none;"><span class ="lookupComponentId">RecipientPostalCountryItemName</span><span class ="fieldId">RecipientPostalCountryItemCode</span><span class ="remoteSourceIdentifier"></span><span class ="remoteLookupCode">SUSR_0086</span><span class="fieldId">ServiceID</span></span></div>
<div title="Vyberte hodnotu" class="LookupForm" style="display: none;">
...
<input class="LookupDetailInfo" type="hidden" />
<span class="lookupbutton ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">Vybrať</span>
<div title="Info" class="LookupDetail"><div class="LookupDetailInfoText"></div><span class="lookupConfiguration" style="display: none;"><span class ="lookupComponentId">RecipientPostalCountryItemNamePO</span><span class ="fieldId">RecipientPostalCountryItemCodePO</span><span class ="remoteSourceIdentifier"></span><span class ="remoteLookupCode">SUSR_0086</span><span class="fieldId">ServiceID</span></span></div>
<div title="Vyberte hodnotu" class="LookupForm" style="display: none;">
		...
		<div class="clear"> </div>
			...
			<div class="clear"> </div>
					...
					<div id="repetitionCommandslayoutRow5025" class="sectionPager">
						<xsl:if test="position() != last()"><xsl:attribute name="style"><xsl:text>display:none;</xsl:text></xsl:attribute></xsl:if>
								<span id="addSectionlayoutRow5025" class="button addRemoveSection" onclick="addSection(1, 9999, this)" title="Pridať sekciu Adresát">Pridať</span>
				<span id="removeSectionlayoutRow5025" class="button addRemoveSection" onclick="removeSection(1, this)" title="Odobrať sekciu Adresát">Odobrať</span>	
			</div>
			</div>	
			</xsl:for-each>	
		...
		<div class="clear"> </div>
			...
			<div class="clear"> </div>
					...
					<div id="repetitionCommandslayoutRow5040" class="sectionPager">
						<xsl:if test="position() != last()"><xsl:attribute name="style"><xsl:text>display:none;</xsl:text></xsl:attribute></xsl:if>
								<span id="addSectionlayoutRow5040" class="button addRemoveSection" onclick="addSection(0, 1, this)" title="Pridať sekciu Na vedomie">Pridať</span>
				<span id="removeSectionlayoutRow5040" class="button addRemoveSection" onclick="removeSection(0, this)" title="Odobrať sekciu Na vedomie">Odobrať</span>	
			</div>
			</div>	
			</xsl:for-each>	
