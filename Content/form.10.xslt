...
maxValue: "Maximálna hodnota položky 'Popis konania / Účastníci konania' musí byť: 4000.0000"
	...
	/* ]]> */
		...
		úplný a presný názov orgánu, ktorý rozhodnutie vydáva (ako je vedený Štatistickým úradom SR
		v Registri organizácií). </span>
																					<span
		...
		že rozhodnutie vydáva konkrétna organizačná zložka, môžete uviesť jej úplný a presný názov. </span>
																					<span
																						class="s_D3FCB7B8"></span>
																				</p>
																			</p>
		...
		identifikátor v zmysle zákona č. 272/2015 Z. z. o registri právnických osôb, podnikateľov a
		orgánov verejnej moci.  Uveďte v tvare bez medzier. </span>
																					<span
		...
		font-family: 'Verdana';font-size: 16px; } </style>
																				<p
																					...
																					<span
																						class="s_A8B3B40B">Uveďte
		päťmiestne alebo štvormiestne číslo. Súčasť identifikátora elektronickej schránky subjektu v
		konkrétnom právnom postavení, ak bol pri zriadení schránky pridelený. Uvádza sa iba
		v prípade, ak má subjekt pre jeden identifikátor osoby (IČO) zriadených viacero
		elektronických schránok v rôznych právnych postaveniach alebo ak sa jedná o nezapísanú
										...
										<div id="layoutCell7571" class="cell  TextArea155x24pxNEW">
											...
											<span class="fieldContent">
												<input id="FileReference" name="FileReference"
													...
													maxlength="128" size="190" alt="" value="">
													<xsl:if
		...
		a presný názov rozhodnutia v zmysle osobitných právnych predpisov, na základe ktorých
		príslušný orgán pri vydaní rozhodnutia postupoval. </span>
																<span class="s_A0B393FA"></span>
															</p>
														</p>
													</div>
		...
		'Verdana';font-size: 16px; } </style>
															<p class="p_6AAD5060">
																<span class="s_C1A2E899">Uveďte
		identifikačné údaje všetkých účastníkov konania (napr. meno, priezvisko, dátum narodenia,
		rodné číslo, adresu trvalého pobytu a pod.) a stručne popíšte samotné konanie, aby bolo
		...
		výroku rozhodnutia vo veci samej, z ktorého budú zrejmé priznané oprávnenia, povinnosti,
		aplikované právne ustanovenia, lehota na plnenie a pod. </span>
																<span class="s_A0B393FA"></span>
															</p>
														</p>
													</div>
		...
		#00B050; } </style>
															<p class="p_6AAD5060">
																<span class="s_A4F101E">Uveďte text
		odôvodnenia výroku rozhodnutia, ktorý zhodnotí skutkový stav, vyjadrenia účastníkov konania,
		zhrnie dokazovanie, zdôvodní posúdenie právneho stavu veci a pod.). </span>
																<span class="s_A0B393FA"></span>
															</p>
														</p>
													</div>
		...
		poučenia rozhodnutia, ktorý bude obsahovať informáciu o prípustnosti alebo neprípustnosti
		podať opravný prostriedok, v akej lehote, akému orgánu a pod.. </span>
																<span class="s_A0B393FA"></span>
															</p>
														</p>
													</div>
								...
								<div id="repetitionCommandslayoutRow5045" class="sectionPager">
									...
									<span id="addSectionlayoutRow5045"
										class="button addRemoveSection"
										onclick="addSection(0, 1, this)"
										title="Pridať sekciu Poučenie">Pridať</span>
									<span id="removeSectionlayoutRow5045"
										class="button addRemoveSection"
										onclick="removeSection(0, this)"
										title="Odobrať sekciu Poučenie">Odobrať</span>
								</div>
							</div>
						</xsl:for-each>
		...
		font-family: 'Verdana';font-size: 16px; } </style>
																				<p
																					...
																					<span
																						class="s_C1A2E899">Môžete
		vpísať číselný údaj predstavujúci počet priložených dokumentov, príklad: 2 prílohy. </span>
																					<span
																						class="s_D3FCB7B8"></span>
																				</p>
																			</p>
		...
		úplné a presné názvy priložených dokumentov, príklad: Diplom, Životopis. </span>
								...
								<div id="repetitionCommandslayoutRow5037" class="sectionPager">
									<xsl:if test="position() != last()"><xsl:attribute name="style"><xsl:text>display:none;</xsl:text></xsl:attribute></xsl:if>
									<span id="addSectionlayoutRow5037"
										class="button addRemoveSection"
										onclick="addSection(0, 1, this)"
										title="Pridať sekciu Príloha">Pridať</span>
									<span id="removeSectionlayoutRow5037"
										class="button addRemoveSection"
										onclick="removeSection(0, this)"
										title="Odobrať sekciu Príloha">Odobrať</span>
								</div>
							</div>
						</xsl:for-each>
		...
		ui-widget-content bezOkrajaBezPozadiaHlavicky nocaption <xsl:if test="position() > 1"><xsl:text> repeatingSection</xsl:text></xsl:if></xsl:attribute>
		...
		font-family: 'Times New Roman';font-size: 16px;color: #00B050; } </style>
																				<p
																					...
																					<span
																						class="s_A4F101E">Uveďte
		pracovné zaradenie osoby oprávnenej rozhodnutie podpísať alebo zapečatiť, príklad: riaditeľ
		odboru verejného obstarávania. </span>
																					<span
																						class="s_A0B393FA"></span>
																				</p>
																			</p>
													...
													<div id="repetitionCommandslayoutRow5064"
														...
														<span id="addSectionlayoutRow5064"
															class="button addRemoveSection"
															onclick="addSection(1, 99, this)"
															title="Pridať sekciu Osoby">Pridať</span>
														<span id="removeSectionlayoutRow5064"
															class="button addRemoveSection"
															onclick="removeSection(1, this)"
															title="Odobrať sekciu Osoby">Odobrať</span>
													</div>
												</div>
											</xsl:for-each>
												...
												<div id="layoutRow5025"
													...
													<xsl:attribute name="id">layoutRow5025<xsl:if
															test="position() > 1"><xsl:text>_Repeating_</xsl:text><xsl:value-of
																select="position()-1" /></xsl:if></xsl:attribute>
													<xsl:attribute name="class">layoutRow ui-tabs
		ui-widget-content dolava8px PozadieLightRed nocaption <xsl:if test="position() > 1"><xsl:text> repeatingSection</xsl:text></xsl:if></xsl:attribute>
		...
		„Vybrať“, vpíšte konkrétny titul udelený adresátovi pred menom (príklad: Bc., Mgr., Ing.,
		MUDr., JUDr.), kliknite na „Hľadať“, vyberte hodnotu z číselníka a prejdite na „OK“. </span>
																															<span
																																class="s_A0B393FA"></span>
																														</p>
																													</p>
																											...
																											<input
																												...
																												type="hidden" />
																											<span
																												class="lookupbutton ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
		Vybrať</span>
																											<div
																												title="Info"
																												class="LookupDetail">
																												<div
																													class="LookupDetailInfoText"></div>
																												<span
																													class="lookupConfiguration"
																													style="display: none;">
																													<span
...
<input
																														...
																														value="Hľadať"
																														alt="Hľadať" />
		Ignorovať diakritiku a veľké písmená <input class="tableFilterIgnoreCaseSensitive"
																														type="checkbox"
		...
		Hodnota</th>
																										...
																										<span
																											class="fieldInfo">
																											<span
																												class="infoIcon ui-icon ui-icon-info"></span>
																										</span>
		...
		*</em>
		...
		{ font-family: 'Times New Roman';font-size: 16px;color: #00B050; } </style>
																														<p
																															...
																															<span
																																class="s_A4F101E">Zvoľte
		„Vybrať“, vpíšte konkrétny titul uvedený adresátovi za priezviskom (príklad: PhD., CSc.,
		DrSc.), kliknite na „Hľadať“, vyberte hodnotu z číselníka a prejdite na „OK“. </span>
																															<span
																																class="s_A0B393FA"></span>
																														</p>
																													</p>
		...
		*</em>
		...
		{ font-family: 'Times New Roman';font-size: 16px;color: #00B050; } </style>
																														<p
																															...
																															<span
																																class="s_A4F101E">Zvoľte
		„Vybrať“, vpíšte presný názov štátu (príklad: Slovenská republika), kliknite na „Hľadať“,
		vyberte hodnotu z číselníka a prejdite na „OK“. </span>
																															<span
																																class="s_A0B393FA"></span>
																														</p>
																													</p>
		...
		*</em>
		...
		{ font-family: 'Times New Roman';font-size: 16px;color: #00B050; } </style>
																														<p
																															...
																															<span
																																class="s_A4F101E">Uveďte
		úplný a presný názov právnickej osoby tak, ako je uvedený v Obchodnom registri SR, prípadne
		v inej evidencii, ak sa právnická osoba nezapisuje do Obchodného registra SR. </span>
																															<span
																																class="s_A0B393FA"></span>
																														</p>
																													</p>
...
<input
		...
		readonly</xsl:attribute><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if>
													...
													<div id="repetitionCommandslayoutRow5025"
														...
														<xsl:if test="position() != last()"><xsl:attribute
																name="style"><xsl:text>display:none;</xsl:text></xsl:attribute></xsl:if>
														<span id="addSectionlayoutRow5025"
															class="button addRemoveSection"
															onclick="addSection(1, 9999, this)"
															title="Pridať sekciu Adresát">Pridať</span>
														<span id="removeSectionlayoutRow5025"
															class="button addRemoveSection"
															onclick="removeSection(1, this)"
															title="Odobrať sekciu Adresát">Odobrať</span>
													</div>
												</div>
											</xsl:for-each>
		...
		adresáta informovať o doručení rozhodnutia ďalším osobám na vedomie, môžete zadať ich úplné
		a presné mená a priezviská/názvy a adresy. </span>
																<span class="s_A0B393FA"></span>
															</p>
														</p>
													</div>
								...
								<div id="repetitionCommandslayoutRow5040" class="sectionPager">
									<xsl:if test="position() != last()"><xsl:attribute name="style"><xsl:text>display:none;</xsl:text></xsl:attribute></xsl:if>
									<span id="addSectionlayoutRow5040"
										class="button addRemoveSection"
										onclick="addSection(0, 1, this)"
										title="Pridať sekciu Na vedomie">Pridať</span>
									<span id="removeSectionlayoutRow5040"
										class="button addRemoveSection"
										onclick="removeSection(0, this)"
										title="Odobrať sekciu Na vedomie">Odobrať</span>
								</div>
							</div>
						</xsl:for-each>
		...
		ReferenceIdentifier </label>
						...
						<div id="buttonsPlaceholder">
							<input id="validateForm" type="button"
								class="button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
								value="Skontrolovať" alt="Skontrolovať" accesskey="S" />
							<input id="clearForm" type="button"
								class="button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
								value="Vyčisti" alt="Vyčisti" accesskey="V" />
							<input id="loadFormXml" type="button"
								class="button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
								value="Načítať" alt="Načítať" accesskey="N" />
							<input id="saveToXml" type="button"
								class="button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
								value="Uložiť" alt="Uložiť" accesskey="U" />
